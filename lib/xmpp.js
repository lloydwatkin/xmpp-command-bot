...
Xmpp.prototype._handleChat = function(stanza) {
    ...
    this.commander.handle(body, function() {
...
Xmpp.prototype._checkIsAllowed = function(from, stanza) {
    ...
    attrs.from = stanza.root().attrs.to
    attrs.to = stanza.root().attrs.from
    var denied = new ltx.builder('chat', attrs)
    denied.c('body', this.PERMISSION_DENIED)
